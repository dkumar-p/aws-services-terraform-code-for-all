locals {
  name_vpc_cluster = "AWS-SMB-test-vpc-pavan"
}
...
module "vpc" {
  ...
  #version = "3.11.0"
  source = "github.com/dkumar-p/terraform-aws-vpc" ####"git@github.com:Iberia-Ent/software-engineering--iac-terraform-aws-vpc-module?ref=v3.11.0"
